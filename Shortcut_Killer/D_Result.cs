...
{
    public partial class D_Result : Form
    {
        public D_Result()
        {
        ...
        public void formClosing(object sender, FormClosingEventArgs e)
        {
            ...
            if (File.Exists(@"D:\cure2.bat"))
            {
                File.Delete(@"D:\cure2.bat");
            }
        }



        private void D_Result_Load(object sender, EventArgs e)
        {
           // this.Visible = true;
            StreamWriter writer = new StreamWriter(@"C:\Picra\D.bat",true);
            writer.WriteLine(@"del D:\*.lnk");
            ...
            writer.WriteLine(@"del D:\x.mpeg");
            writer.Close();
            new StreamWriter(@"C:\Picra\D.ini").Close();
            try
            {
                ...
                writer3.WriteLine(@"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            attrib -s -h -r -a /S /D D:\*");
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                int drivestatus = zero.validateDriveStatus(@"D:\");
                ...
                else if (this.progressBar2.Value == 700)
                {
                    ...
                    string[] strArray = Directory.GetFiles(@"D:\", "*.exe", SearchOption.TopDirectoryOnly);
                    ...
                    for (int i = 0; i < length; i++)
                    {
                        ...
                        if (info2.Length < 0xdbba0L)
                        {
                            ...
                            if ((((str3.ToString() == str5.ToString()) || (str5.ToString() == str4.ToString())) || ((str3.ToString() == str5.ToString()) && (str3.ToString() == str4.ToString()))) || (str3.ToString() == str4.ToString()))
                            {
                                ...
                                try
                                {
                                    if (Directory.GetDirectories(@"D:\" + fileNameWithoutExtension).Length == 0)
                                    {
                                        splash.shortcutResult.Items.Add(fileNameWithoutExtension.ToString());
                                        Directory.Delete(@"D:\" + fileNameWithoutExtension);
                                    }
                                    goto Label_04A3;
                                }
                                catch (Exception)
                    ...
                    if (this.sumT == 0)
                    {
                        ProcessStartInfo info3 = new ProcessStartInfo(@"C:\Picra\D.bat")
                        {
                            UseShellExecute = false,
                            CreateNoWindow = true,
                            RedirectStandardOutput = true,
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            if (this.progressBar2.Value == 160)
            {
                try
                {
                    if (Directory.Exists(@"D:\589485658"))
                    {
                        string[] files = Directory.GetFiles(@"D:\589485658");
                    ...
                    Directory.Delete(@"D:\589485658");
                }
                catch (Exception)
                {
                }
            }
            if (this.progressBar2.Value == 300)
            {
                ProcessStartInfo info2 = new ProcessStartInfo(@"C:\Picra\D.bat")
                {
                    UseShellExecute = false,
                    CreateNoWindow = true,
                    RedirectStandardOutput = true,
                ...
                string[] strArray3 = Directory.GetFiles(@"D:\", "*.lnk", SearchOption.TopDirectoryOnly);
            ...
            if (this.progressBar2.Value == 400)
            {
                this.timer2.Stop();
                Application.Restart();
            }
